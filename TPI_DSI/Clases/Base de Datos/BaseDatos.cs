...
namespace TPI_DSI.Clases
{
    internal class BaseDatos
    {
        ...
        public BaseDatos()
        {
            ...
            turno.fechaHoraInicio = DateTime.Parse("15/7/2022 11:00:00");
            ...
            cambioEstadoTurno.estado = Disponible;
            cambioEstadoTurno.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno3 = new CambioEstadoTurno();
            cambioEstadoTurno3.estado = Disponible;
            cambioEstadoTurno3.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno2 = new CambioEstadoTurno();
            cambioEstadoTurno2.estado = Disponible;
            cambioEstadoTurno2.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno4 = new CambioEstadoTurno();
            cambioEstadoTurno4.estado = Reservado;
            cambioEstadoTurno4.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno5 = new CambioEstadoTurno();
            cambioEstadoTurno5.estado = Disponible;
            cambioEstadoTurno5.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno6 = new CambioEstadoTurno();
            cambioEstadoTurno6.estado = Disponible;
            cambioEstadoTurno6.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno7 = new CambioEstadoTurno();
            cambioEstadoTurno7.estado =  Disponible;
            cambioEstadoTurno7.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno8 = new CambioEstadoTurno();
            cambioEstadoTurno8.estado = Disponible;
            cambioEstadoTurno8.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno9 = new CambioEstadoTurno();
            cambioEstadoTurno9.estado = Disponible;
            cambioEstadoTurno9.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno10 = new CambioEstadoTurno();
            cambioEstadoTurno10.estado = Disponible;
            cambioEstadoTurno10.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno11 = new CambioEstadoTurno();
            cambioEstadoTurno11.estado = Disponible;
            cambioEstadoTurno11.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno12 = new CambioEstadoTurno();
            cambioEstadoTurno12.estado = Disponible;
            cambioEstadoTurno12.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno13 = new CambioEstadoTurno();
            cambioEstadoTurno13.estado = Disponible;
            cambioEstadoTurno13.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno14 = new CambioEstadoTurno();
            cambioEstadoTurno14.estado = Disponible;
            cambioEstadoTurno14.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno15 = new CambioEstadoTurno();
            cambioEstadoTurno15.estado = Disponible;
            cambioEstadoTurno15.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno16 = new CambioEstadoTurno();
            cambioEstadoTurno16.estado = Disponible;
            cambioEstadoTurno16.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno17 = new CambioEstadoTurno();
            cambioEstadoTurno17.estado = Disponible;
            cambioEstadoTurno17.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno18 = new CambioEstadoTurno();
            cambioEstadoTurno18.estado = Disponible;
            cambioEstadoTurno18.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno19 = new CambioEstadoTurno();
            cambioEstadoTurno19.estado = Disponible;
            cambioEstadoTurno19.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno20 = new CambioEstadoTurno();
            cambioEstadoTurno20.estado = Disponible;
            cambioEstadoTurno20.fechaHoraDesde = DateTime.Now;
            CambioEstadoTurno cambioEstadoTurno21 = new CambioEstadoTurno();
            cambioEstadoTurno21.estado = Disponible;
